    ...
    <Container>
      ...
      <Card title="Raychat + Next.js">
        <Content>
          ...
          <div className="mt-1">
            برای کار کردن رایچت با نکست، کاستوم هوک برای عملیات کاربردی و بسیار
            مهم رایچت ایجاد کردم که براحتی بشه استفاده کرد تو هر پروژه نکست.
            برای مثال
            <Link
